...
// const AddressBar = () => (
//   <Route
//     render={({ location: { pathname }, history }) => (
//       <div className="address-bar">
//         <div>
//           <button className="ab-button" onClick={history.goBack}>
//             ◀︎
//           </button>
//         </div>
//         <div>
//           <button className="ab-button" onClick={history.goForward}>
//             ▶
//           </button>
//         </div>
